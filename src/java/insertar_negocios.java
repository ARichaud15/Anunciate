...
public class insertar_negocios extends HttpServlet 
{
    ...
    private void InsertarNegocio(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
        ...
        int ID_usuarios = (int) sesion.getAttribute("sessionID_usuarios");
        ...
        RequestDispatcher paginaAltas = contexto.getRequestDispatcher("/Negocios.jsp");
