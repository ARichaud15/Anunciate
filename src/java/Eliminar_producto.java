...
public class Eliminar_producto extends HttpServlet 
{
    ...
    public void init(ServletConfig config) 
    {
        ...
        {
            Logger.getLogger(Eliminar_producto.class.getName()).log(Level.SEVERE,
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
        ...
        request.setAttribute("error", "El producto se a eliminado correctamente ");
    ...
    {
        ServletContext contexto  = request.getServletContext();
        Logger.getLogger(Eliminar_producto.class.getName()).log(Level.SEVERE, "No se pudo ejecutar la consulta contra la base de datos", ex);
        
        request.setAttribute("error", "A ocurrido un error al eliminar el producto");
