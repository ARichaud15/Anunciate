...
public class Eliminar_negocio extends HttpServlet 
{
    ...
    public void init(ServletConfig config) 
    {
        ...
        {
            Logger.getLogger(Eliminar_negocio.class.getName()).log(Level.SEVERE,
        ...
        {
            Logger.getLogger(Eliminar_negocio.class.getName()).log(Level.SEVERE, null, ex);
        } 
    ...
    protected void doPost (HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException 
    {
        ...
        try 
        {
            query = "DELETE FROM negocios WHERE ID_negocios = " + ID_negocios + "";
        ...
        request.setAttribute("error", "El negocio a sido dado de baja con exito ");
    ...
    {
        ServletContext contexto  = request.getServletContext();
        Logger.getLogger(Eliminar_negocio.class.getName()).log(Level.SEVERE, "No se pudo ejecutar la consulta contra la base de datos", ex);
        
        request.setAttribute("error", "El negocio no se ha podido dar de baja");
