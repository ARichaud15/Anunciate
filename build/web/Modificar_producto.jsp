...
<html>
    <head>
        <title>Modificar producto - Anunciate!</title>
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    ...
                                                                    query = "SELECT * FROM productos WHERE ID_productos = " + ID_producto + "";
                                                                    ...
                                                                    if(resultSet.next())
                                                                    {
                                                                        out.println("<input type='text' name='ID_productos'  style='display:none' readonly='readonly' value="+resultSet.getString("ID_productos")+">");
                                                                %>
                                                                <tr>
                                                                    <td>
                                                                        <h4>Nombre</h4>
                                                                        <% out.println("<input type='text' name='Nombre_productos' required='' value='" +resultSet.getString("Nombre_productos")+"'>");%>
                                                                    </td>
                                                                    <td>
                                                                        <h4>Descripcion</h4>
                                                                        <% out.println("<input type='text' name='Descripcion_productos' required='' value='" +resultSet.getString("Descripcion_productos")+"'>");%>
                                                                    </td>
                                                                    <td>
                                                                        <h4>Precio</h4>
                                                                        <% out.println("<input type='text' name='Precio_productos' required='' value='" +resultSet.getString("Precio_productos")+"'>"); }%>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
