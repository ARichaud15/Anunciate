...
<html>
    <head>
        <title>Promociones - Anunciate!</title>
                                                ...
                                                <div class="table-responsive">
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                <%
                                                                    int band = 0;
                                                                    query = "SELECT * FROM promociones WHERE ID_negocios = " + sesion.getAttribute("sessionID_negocios") + "";
                                                                    ...
                                                                    while(resultSet.next())
                                                                    {
                                                                        out.println("<tr>");
                                                                            ...
                                                                            out.println("<td> "
                                                                                    + "<form action='Modificar_promociones.jsp' method='post'>"
                                                                                        + "<button type='submit' value='Modificar' class='btn btn-primary'>Modificar</button>" 
                                                                                        + "<input type='text' name='ID_promociones'  style='display:none' readonly='readonly' value="+resultSet.getString("ID_promociones")+">"
                                                                                    + "</form> "
                                                                                    + "<form action='Eliminar_promociones' method='post'>"
