			...
			<div class="clearfix"></div>
                    ...
                    <div class="outter-wp">
                        ...
                        <%
                            ...
                            query = "SELECT usuarios.* FROM negocios INNER JOIN usuarios on negocios.ID_usuarios = usuarios.ID_usuarios where negocios.ID_negocios=" + ID_negocios + "";
                        ...
                        %>
                         ...
                         <div class="forms-main">
                            <h2 class="inner-tittle">Datos del cliente</h2>
                                    ...
                                    <div class="validation-form">
                                        <div class="vali-form">
                                            <div class="col-md-4 form-group1 group-mail">
                                                    ...
                                                    <% 
                                                        out.println("<input type='text' name='Nombre' readonly='readonly' value='"+ resultSet.getString("Nombre_usuarios")+" "+resultSet.getString("ApellidoPa_usuarios")+" "+resultSet.getString("ApellidoMa_usuarios")+ "'>");
                                                    %>
                                            </div>

                                                <div class="col-md-4 form-group1">
                                                    <label class="control-label">Telefono</label>
                                                    <% out.println("<input type='text' name='Telefono' readonly='readonly' maxlength='10' value='" +resultSet.getString("Telefono_usuarios")+"'>");%>
                                                </div>

                                                <div class="col-md-4 form-group1 group-mail">
                                                    <label class="control-label">Correo</label>
                                                    <% out.println("<input type='email' name='Correo' readonly='readonly' required='' value='" +resultSet.getString("Correo_usuarios")+"'>");}%>
                                                </div>
                                                <div class="clearfix"> </div>
                                        </div>
                        ...
                        <div class="forms-main">
                            ...
                            <div class="graph-form">
                                <div class="validation-form">
                                        ...
                                        <div class="vali-form">
                                            <form action="Eliminar_negocio" method="post">
                                                ...
                                                %>
                                                <a href='Actualizar_negocios.jsp'><button type='button' value='Modificar' class='btn btn-primary'>Modificar datos</button></a>
                                                <button type="submit" value="Eliminar" class="btn btn-primary">Eliminar negocio</button>
